<template>
        ...
        <AuthenticatedLayout>
            ...
            <div class="max-w-[1000px] mx-auto flex gap-2 h-[270px]">
                ...
                <div v-if="$page.props.auth.address" class="relative border border-gray-400 rounder-md w-1/3 shadow-md">
                    <div class="flex items-center justify-start p-3 text-xs text-gray-600 font-extrabold border-b border-gray-400">

...
class CheckoutController extends Controller
{
    ...
    {
        $stripe = new \Stripe\StripeClient('sk_test_51MTq3XJ5Cxj1eH7cfmaEooApunuqWeS6Q6rTUeNxR3UwqLx3ZX0wnhY6WBv9ESvJCuf1Wmd8PFM0qEbVfLf3aSxY006bh7QtYJ');
        ...
        // if(is_null($order)) {
        //     return redirect()->route('chekout_success.index');
        // }
